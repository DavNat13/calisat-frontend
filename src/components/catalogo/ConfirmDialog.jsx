export default function ConfirmDialog({ sku, onConfirm, onCancel }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="bg-surface-2 border border-border-strong rounded-lg p-6 max-w-sm mx-4">
        ...
        <div className="flex gap-3 justify-end">
          ...
          <button
            ...
            className="bg-danger hover:bg-danger/90 text-white text-sm px-4 py-2 rounded transition-colors"
          >
            Eliminar
          </button>
        </div>
