    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <a
            href="/productos"
            className="inline-block bg-primary hover:bg-primary-hover text-white font-medium px-8 py-3 rounded-lg transition-colors"
          >
            Ver Catálogo
          </a>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <p className="text-text-muted">{cat.descripcion}</p>
              </div>
            ))}
          </div>
        </div>
